...
<div class="form-group">
<label class="col-sm-9 text-left">Grupo de Clase</label>
<div class="col-sm-12">
<input type="password" name="txt_password" class="form-control" placeholder="Ingrese a que clase pertenece" />
</div>
</div>
...
<div class="form-group">
    ...
    <select class="form-control" name="txt_role">
        ...
        <option value="personal">Profesor</option>
        <option value="usuarios">Alumno</option>
    </select>
    </div>
</div>
