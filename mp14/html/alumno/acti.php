...
function actividades(){
    ...
    if(!empty($_GET['asignatura'])){
        ...
        echo '<h1 class="h1">Actividades de ' . $asignatura . ":</h1><br>";

        $result = $conn->prepare("SELECT examen.nombre, examen.exam_id FROM asignatura, examen WHERE examen.asig_id = asignatura.asig_id");
