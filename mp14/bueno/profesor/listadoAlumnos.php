...
$result = $conn->prepare(" SELECT users_id as 'id', nombre, apellidos, mail, pw as 'password', curso_id, rol FROM usuari WHERE rol = 'alumno' ");
    ...
    <body>
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="search">
                    <div class="sBox">
                        <input type="text" placeholder="Nombre del alumno" class="sText" id="inpSrch">
                ...
                <div class="buttons">
                    <button id="myBtn" class="newProf">Añadir alumno</button>
        ...
        <script type="text/javascript" src="listAlumnos.js"></script>
