...
function setTipoAsignatura(){
    ...
    option0.appendChild(document.createTextNode("Seleccione una asignatura"));
    sel.appendChild(option0);
    let option1 = document.createElement("option");
    option1.appendChild(document.createTextNode("Mates"));
    option1.setAttribute('value', "Mates" );
    option1.setAttribute('name', "Mates" );
